...
export default function TravelogueAll({ document }: PropsWithChildren<{ document: PrismicDocument[] }>) {
  useEffect(() => {
    if (!document) return
              ...
              <main>
                <div className="__travel" id="travel">
                  <div className="travel__body full">
                    <h1>Our Africa-Wide Work</h1>
                    <div className="travel__left full">
                      {document?.map((doc, i) => (
                        <div key={i}>
                          <h2>📍 {doc?.data.title[0].text}</h2>
                          <ul>
                            {doc?.data.contents.map((li, i) => (
                              <div key={i}>
                                <li>
                                  <div>
